...
import { Scale, Users, FileText, Shield, Clock, CheckCircle } from "lucide-react"
  ...
  const services = [
    {
      ...
      features: ["Contract Review", "Business Formation", "M&A Support", "Compliance Consulting"],
    ...
    },
    {
      ...
      description: "Property transactions, disputes, zoning, commercial real estate",
      features: ["Property Transactions", "Title Review", "Zoning Issues", "Commercial Leases"],
    ...
    },
    {
      ...
      features: ["Criminal Defense", "DUI Cases", "Appeals", "Record Expungement"],
    ...
    },
    {
      ...
      features: ["Accident Claims", "Medical Malpractice", "Wrongful Death", "Insurance Disputes"],
    ...
    },
    {
      ...
      features: ["Visa Applications", "Citizenship Process", "Deportation Defense", "Family Reunification"],
      ...
      <div className="container mx-auto px-4 py-16">
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-muted-foreground max-w-2xl mx-auto">
            Comprehensive legal services from verified professionals across all practice areas
          </p>
        </div>
        ...
        <div className="mt-16 text-center">
          ...
          <p className="text-muted-foreground mb-6">
            Not sure which legal service you need? Our team can help you find the right professional for your situation.
          </p>
